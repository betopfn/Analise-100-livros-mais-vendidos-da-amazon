...
# lista para rodar os dois filtros em uma mesma tabela
df_books = df_top_100_books[
    (df_top_100_books["book price"] <= filter_price) &  # Price condition
    (df_top_100_books["year of publication"] <= filter_year)   # Year condition
]
